...
PrivateData = @{
    PSData = @{
        ...
        LicenseUri = 'https://github.com/nholuongut/posh-git/blob/main/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/nholuongut/posh-git'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/nholuongut/posh-git/blob/main/CHANGELOG.md'
